            ...
            <section class="section-animate w-full flex flex-col items-center justify-center py-12 px-5 bg-wedding-bg relative overflow-hidden">
                ...
                <div class="reveal mb-6" data-reveal>
                    <svg width="72" height="44" viewBox="0 0 72 44" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <circle cx="26" cy="22" r="18" stroke="#8B1538" stroke-width="2.5" fill="none" opacity="0.85"/>
                        <circle cx="46" cy="22" r="18" stroke="#8B1538" stroke-width="2.5" fill="none" opacity="0.85"/>
                        <circle cx="26" cy="22" r="12" stroke="#D4AF37" stroke-width="1.2" fill="none" opacity="0.5"/>
                        <circle cx="46" cy="22" r="12" stroke="#D4AF37" stroke-width="1.2" fill="none" opacity="0.5"/>
                    </svg>
                </div>
                ...
                <div class="w-full max-w-[420px] relative z-10">
                    ...
                    <div class="flex flex-col gap-3 mb-6">
                        ...
                        <div class="reveal flex items-start gap-3 bg-white/72 backdrop-blur-sm border border-black/08 rounded-2xl px-4 py-4 shadow-sm" data-reveal>
                            <span class="mt-0.5 shrink-0 w-8 h-8 rounded-full bg-wedding-red/10 flex items-center justify-center">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8B1538" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- Action buttons -->
                    <div class="reveal rounded-[22px] overflow-hidden border border-black/10 shadow-lg shadow-black/10 bg-white p-4" data-reveal>
                        <div class="flex flex-col gap-3">
                            ...
                            <a href="${escapeAttr(eventCalLink)}" target="_blank"
                               ...
                               <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                               Save Google Calendar
                            </a>
                        </div>
                    </div>

        ...
        <div class="w-full flex flex-col items-center">
            ...
            <div class="text-center mt-10 px-2 z-10 w-full reveal" data-reveal>
                ...
                <div class="mt-6 flex justify-center">
                    <a href="${escapeAttr(person.mapUrl)}" target="_blank" class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/90 backdrop-blur shadow-[0_4px_16px_rgba(91,45,142,0.08)] border border-[rgba(91,45,142,0.12)] text-[#5B2D8E] group hover:bg-[#5B2D8E] hover:text-white hover:shadow-[0_8px_24px_rgba(91,45,142,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <span class="text-[10px] tracking-[0.2em] uppercase font-bold opacity-90 group-hover:opacity-100">Home Location</span>
                    </a>
                </div>
                ` : ''}
            </div>
